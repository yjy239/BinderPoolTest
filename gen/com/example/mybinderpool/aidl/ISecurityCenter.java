 ...
 * Original file: E:\\818workspace\\MyBinderPool\\src\\com\\example\\mybinderpool\\aidl\\ISecurityCenter.aidl
 */
package com.example.mybinderpool.aidl;
public interface ISecurityCenter extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.mybinderpool.aidl.ISecurityCenter
{
private static final java.lang.String DESCRIPTOR = "com.example.mybinderpool.aidl.ISecurityCenter";
...
/**
 * Cast an IBinder object into an com.example.mybinderpool.aidl.ISecurityCenter interface,
 * generating a proxy if needed.
 */
public static com.example.mybinderpool.aidl.ISecurityCenter asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.mybinderpool.aidl.ISecurityCenter))) {
return ((com.example.mybinderpool.aidl.ISecurityCenter)iin);
}
return new com.example.mybinderpool.aidl.ISecurityCenter.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.mybinderpool.aidl.ISecurityCenter
{
